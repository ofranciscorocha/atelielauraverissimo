            ...
            {categories.map((cat) => (
              <button
                ...
                className={cn(
                  ...
                  cat === selectedCategory ? "border-[#304930] text-[#304930]" : "border-transparent text-slate-400 hover:text-[#304930]"
                )}
              >
                {cat}
              </button>
          ...
          {filteredProducts.length === 0 && (
            <div className="col-span-full py-40 flex flex-col items-center justify-center space-y-8 animate-in fade-in zoom-in duration-700">
              ...
              <div className="text-center">
                <h3 className="text-2xl font-serif text-[#304930] mb-2">Nenhum produto encontrado.</h3>
                <p className="text-sm text-slate-400 font-medium">Tente buscar com outras palavras-chave.</p>
              </div>
            </div>
          )}
        </div>
